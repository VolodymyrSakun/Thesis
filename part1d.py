...
def main(sData, dataDir, resultsDir):
    ...
    # sData = 'SimulatedShort001' # 'SimulatedShort001', 'Simulated1'
    ...
    # all fetures, shorter survival time
    ...
    # descriptorsList = ['D_State', 'activity']
...
# alive if activity in [1, 2, 3, 4, 5, 7, 9, 11, 14]:
# D_State = (self.dState - dBirthState).days
# dead elif activity in [6, 8, 10, 12]:
